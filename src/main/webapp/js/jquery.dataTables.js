 ...
 * Version:     1.7.0
 * CVS:         $Id: jquery.dataTables.js,v 1.1 2010/08/27 02:50:10 blue Exp $
 * Description: Paginate, search and sort HTML tables
 * Author:      Allan Jardine (www.sprymedia.co.uk)
 * Created:     28/3/2008
 * Modified:    $Date: 2010/08/27 02:50:10 $ by $Author: blue $
 * Language:    Javascript
...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			 ...
			 */
			this.oLanguage = {
				"sProcessing": /*"Processing..."*/ "处理中...",
				"sLengthMenu": /*"Show _MENU_ entries"*/ "显示 _MENU_ 条记录",
				"sZeroRecords": /*"No matching records found"*/ "没有找到匹配的记录",
				"sEmptyTable": /*"No data available in table"*/ "表中没有有效数据",
				"sInfo": /*"Showing _START_ to _END_ of _TOTAL_ entries"*/ "显示 _START_ 到 _END_ 共 _TOTAL_ 条",
				"sInfoEmpty": /*"Showing 0 to 0 of 0 entries"*/ "没有记录显示",
				"sInfoFiltered": /*"(filtered from _MAX_ total entries)"*/ "(从总共 _MAX_ 条记录中过滤)",
				"sInfoPostFix": "",
				"sSearch": /*"Search:"*/ "查询:",
				"sUrl": "",
				"oPaginate": {
					"sFirst":    /*"First"*/ "首页",
					"sPrevious": /*"Previous"*/ "上一页",
					"sNext":     /*"Next"*/ "下一页",
					"sLast":     /*"Last"*/ "尾页"
				}
			};
